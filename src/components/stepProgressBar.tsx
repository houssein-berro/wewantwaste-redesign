...
export default function StepProgressBar({ currentStepKey }: Props) {
  ...
  return (
    <nav className="w-full bg-background py-4 mb-4">
 
      <div className="overflow-x-auto step-scrollbar">
        <motion.ol
          className="max-w-4xl mx-auto flex items-center justify-between px-4 py-2 md:px-0"
